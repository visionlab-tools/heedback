...
interface MessageDigestUserProps {
  t: {
    preview: string
    heading: string
    description: string
...
export default function MessageDigestUser({ t, orgName, messageCount, messagesHtml, conversationUrl }: MessageDigestUserProps) {
  return (
    <Html>
      <Head />
      <Preview>{t.preview.replace('{{orgName}}', orgName)}</Preview>
      <Body style={main}>
        <Container style={container}>
          <Heading style={heading}>{t.heading}</Heading>
          <Text style={text}>
            {t.description.replace('{{messageCount}}', messageCount).replace('{{orgName}}', orgName)}
          </Text>
          ...
          <Hr style={hr} />
          <Text style={footer}>
            {t.footer.replace('{{orgName}}', orgName)}
          </Text>
        </Container>
      </Body>
    </Html>
