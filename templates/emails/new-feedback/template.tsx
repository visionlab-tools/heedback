...
export default function NewFeedback({ t, postTitle, boardName, authorName, postUrl, orgName }: NewFeedbackProps) {
  return (
    <Html>
      <Head />
...
const meta = { fontSize: '16px', color: '#1a1a1a', padding: '16px', backgroundColor: '#f0f0f0', borderRadius: '6px' }
const button = {
