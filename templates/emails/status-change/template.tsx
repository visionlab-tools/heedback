...
export default function StatusChange({ t, postTitle, newStatus, postUrl, orgName }: StatusChangeProps) {
  return (
    <Html>
      <Head />
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={status}>
            <strong>{postTitle}</strong> → {newStatus}
          </Text>
...
const status = { fontSize: '16px', color: '#1a1a1a', padding: '16px', backgroundColor: '#f0f0f0', borderRadius: '6px' }
const button = {
